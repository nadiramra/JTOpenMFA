...
public interface ProfileTokenImpl extends AS400CredentialImpl
{
     ...
     * @param timeoutInterval The number of seconds before expiration.
     * 
     * @param verificationID  The verification ID that will be associated with
     *                        profile token. The verification ID is the label that
     *                        identifies the specific application, service, or
     *                        action associated with the profile token request.
     * 
     * @param remoteIPAddress The remote IP address that will be associated with
     *                        profile token.
     *
     * @return The new token.
     *
     ...
     *
     */
    byte[] refresh(int type, int timeoutInterval, String verificationID, String remoteIPAddress)
